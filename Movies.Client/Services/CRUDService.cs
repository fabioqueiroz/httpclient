...
namespace Movies.Client.Services
{
    public class CRUDService : IIntegrationService
    {
        ...
        // Shortcut versions
        // **** The 'Accept' header in these cases is not automatically set nor sent, which is obligatory for RESTful systems;
        // we can set DefaultRequestHeaders.Accept at the client level, but that's only OK when all the requests have to 
        // be sent with the same The 'Accept' header ****
